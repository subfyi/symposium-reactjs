...
import {Menu, MenuGroup, Sidebar} from 'react-admin-base-falcon';
...
export default injectIntl(function MenuSidebar() {
    ...
    return <Sidebar>
        ...
        {user.role >= 1 && <MenuGroup title="Submission">
            {user.role >= 8 &&
                <Menu title={"Send Paper"} to={import.meta.env.VITE_ENDLOCAL + "/submission/create"} icon="fas fa-book-open"/>}
